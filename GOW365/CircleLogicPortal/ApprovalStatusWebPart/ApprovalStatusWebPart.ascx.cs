...
namespace CircleLogicPortal.ApprovalStatusWebPart
{
    ...
    public partial class ApprovalStatusWebPart : WebPart
    {
        protected string ImgUrl = "GOW365/ApprovalStatus/";
        ...
        WebDisplayName("Approval List Url"),
        WebDescription("1")]
        ...
        WebBrowsable(true),
        Category("Approval List"),
        WebDisplayName("Approval List Name"),
        WebDescription("1")]
