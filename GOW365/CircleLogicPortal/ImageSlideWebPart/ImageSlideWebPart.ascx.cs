...
namespace CircleLogicPortal.ImageSlideWebPart
{
    ...
    public partial class ImageSlideWebPart : WebPart
    {
        ...
        protected string ImgUrl = "GOW365/ImageSlide/";
        ...
        [WebBrowsable(true),
         ...
         DefaultValue("false"),
         Category("Picture"),
         WebDisplayName("Show Button"),
         WebDescription("Show Button")]
